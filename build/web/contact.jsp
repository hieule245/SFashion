        ...
        <div class="container-fluid pt-5">
            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-5 mb-5">
                    ...
                    <p>Let's review honestly, we approciate highly your rating!</p>
                    <div class="d-flex flex-column mb-3">
                        <h5 class="font-weight-semi-bold mb-3">Store 1</h5>
                        <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Quy Nhon, Binh Dinh</p>
                        <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>fashionapp@example.com</p>
                        <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+84 0123 456 789</p>
                    </div>
                    <div class="d-flex flex-column">
                        <h5 class="font-weight-semi-bold mb-3">Store 2</h5>
                        <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Pleiku, Gia Lai</p>
                        <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>fashionapp@example.com</p>
