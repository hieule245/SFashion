...
public class DiscountManagerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Discount> discountList = dao.pagingDiscounts(index);
        if (search!=null) {
            discountList = discount.findDiscountssByString(discountList,search);
        }
        session.setAttribute("ListAllDiscounts", discountList);
