    ...
    <body>
        ...
        <div class="container-fluid bg-secondary mb-5">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
                <h1 class="font-weight-semi-bold text-uppercase mb-3">Categories Manager</h1>
                <div class="d-inline-flex">
                    <p class="m-0"><a href="index.jsp">Home</a></p>
                    <p class="m-0 px-2">-</p>
                    <p class="m-0">Categories Manager</p>
                </div>
            </div>
        </div>
        <!-- Page Header End -->
                ...
                <div class="table-title">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody id="listCustomer" class="align-middle">
                            <c:forEach items="${sessionScope.slistCC}" var="item">
                                <tr id="item" data-id="${item.getCategoryId()}">
