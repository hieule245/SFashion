<%-- 
    Document   : footer
    Created on : Aug 17, 2023, 11:27:43 PM
    Author     : Raiku
--%>
...
<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
    <div class="container">
    <div class="row justify-content-center"> <!-- Centering the rows -->
        ...
        <div class="col-lg-6 col-md-12">
            <div class="row justify-content-center"> <!-- Centering the nested row -->
